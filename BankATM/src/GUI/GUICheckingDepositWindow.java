 ...
 *
 */
public class GUICheckingDepositWindow extends GUIDepositWindow{

    public GUICheckingDepositWindow(Customer customer){
        super(customer);

        // title
        setTitle("Deposit to Checking Account");
    ...
    /**
     * customer deposit an amount into his/her checking account
     */
    class ConfirmListener implements ActionListener {
        public void actionPerformed(ActionEvent e){
            ...
            try{
                ...
                JOptionPane.showMessageDialog(dwPanel,"Successfully deposit to Checking account","Success",JOptionPane.PLAIN_MESSAGE,IconUtil.confirmIcon);

            }catch(Exception ex){
                if(amount == null){
                    JOptionPane.showMessageDialog(dwPanel,"You should input a number",
                            "Error",JOptionPane.ERROR_MESSAGE,IconUtil.closeIcon);
                    return;
                }
