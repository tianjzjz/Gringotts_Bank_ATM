...
import BankAttributes.Interest;
 ...
 */
public class GUICheckingWithdrawWindow extends GUIWithdrawWindow implements Interest {

    public GUICheckingWithdrawWindow(Customer customer){
        super(customer);

        // title
        setTitle("Withdraw from Checking Account");
    ...
    /**
     * customer withdraws an amount of money from his/her checking account and charge a service fee
     */
    class ConfirmListener implements ActionListener {
        public void actionPerformed(ActionEvent e){
            ...
            try{
                ...
                int choice = JOptionPane.showConfirmDialog(wwPanel,"You will be charged $"+fee+" as service fee from your balance","Warning",JOptionPane.OK_CANCEL_OPTION,JOptionPane.WARNING_MESSAGE,IconUtil.warnIcon);
                if(choice == 0){
                    ...
                    if (withdrawAmount != 0.0) {
                        ...
                        JOptionPane.showMessageDialog(wwPanel,"Successfully withdraw from Checking account","Success",JOptionPane.PLAIN_MESSAGE,IconUtil.confirmIcon);
                    } else {
                ...
                if(amount == null){
                    JOptionPane.showMessageDialog(wwPanel,"You should input a number","Error",JOptionPane.ERROR_MESSAGE,IconUtil.closeIcon);
                    return;
                }
